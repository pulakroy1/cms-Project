...
$DateTime =strftime("%B-%d-%Y %H:%M:%S");
 ...
 $target="upload/".basename( $_FILES["image"]["name"]);
    ...
    elseif(strlen($title)<3){
        ...
        global $connection;
        $EditFormUrl=$_GET['Edit'];
        $Query="UPDATE admin_panel SET datetime='$DateTime',title='$title',category='$category',author='$admin',image='$image',post='$post' WHERE id='$EditFormUrl'";
    ...
    <form action="EditPost.php?Edit=<?php echo $searchqueryParameter; ?>"method="post"enctype="multipart/form-data" >
        <fieldset>
            <div class="form-group">
                ...
                <input value="<?php echo $titleToBeUpdaate?>" class="form-control" type="text"name="title" id="title" placeholder=" Update Title">
            </div> 
            ...
            <div>
                <input class="btn btn-success btn-block mt-2" type="submit"name="submit"value="Update Post">
                <br>
            </div>
